...
import (
	...
	"github.com/gkwa/funnymontana/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.funnymontana.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".funnymontana")
	}
